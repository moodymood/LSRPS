...
<script RunAt="server">
    private static MetaModel my_RPSLSModel = new MetaModel();
    public static MetaModel RPSLSModel {
        get {
            return my_RPSLSModel;
        }
    }
    ...
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        my_RPSLSModel.RegisterContext(typeof(RPSLSDataContext),
